...
public class Book {
	...
	public String getPress() {
		if (press == null)
			System.out.println("¬ведите издательство");
		return press;
	}
	...
	public void setYear(int year) {
		if (year >= FIRSTBOOKYEAR && year <= CURRENTYEAR)
			...
			System.out.println("Ќеверный год!");
	}

	public int getPages() {
		if (pages == 0)
			System.out.println("¬ведите количество страниц");
		return pages;
	}
	...
	public String getCover() {
		if (cover == null)
			System.out.println("¬џведите тип обложки");
		return cover;
	}
